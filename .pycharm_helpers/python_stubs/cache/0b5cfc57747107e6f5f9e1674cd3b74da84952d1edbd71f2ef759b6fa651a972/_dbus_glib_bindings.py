...
__spec__ = None # (!) real value is "ModuleSpec(name='_dbus_glib_bindings', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc83f160>, origin='/usr/lib/python3/dist-packages/_dbus_glib_bindings.cpython-36m-x86_64-linux-gnu.so')"
