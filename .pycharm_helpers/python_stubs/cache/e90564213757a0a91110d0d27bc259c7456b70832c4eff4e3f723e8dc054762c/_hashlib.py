...
openssl_md_meth_names = None # (!) real value is "frozenset({'md5-sha1', 'sha384', 'shake256', 'ripemd160', 'sha3-512', 'md5', 'sha512-224', 'sm3', 'sha3-224', 'sha256', 'blake2s256', 'sha512-256', 'sha224', 'md4', 'sha1', 'sha3-256', 'shake128', 'sha512', 'blake2b512', 'whirlpool', 'sha3-384'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc878b38>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc878b38>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
