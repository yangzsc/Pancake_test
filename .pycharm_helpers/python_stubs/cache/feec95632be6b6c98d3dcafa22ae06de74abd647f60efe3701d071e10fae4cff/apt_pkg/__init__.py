...
config = None # (!) real value is '<apt_pkg.Configuration object at 0x7efebc7e1940>'
...
_C_API = None # (!) real value is '<capsule object "apt_pkg._C_API" at 0x7efebc828c30>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc83f160>'

__spec__ = None # (!) real value is "ModuleSpec(name='apt_pkg', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc83f160>, origin='/usr/lib/python3/dist-packages/apt_pkg.cpython-36m-x86_64-linux-gnu.so')"
