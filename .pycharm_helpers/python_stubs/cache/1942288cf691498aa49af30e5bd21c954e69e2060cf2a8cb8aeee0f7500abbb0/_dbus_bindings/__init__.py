...
NULL_MAIN_LOOP = None # (!) real value is '<dbus.mainloop.NativeMainLoop object at 0x7efebc828fc0>'

_C_API = None # (!) real value is '<capsule object "_dbus_bindings._C_API" at 0x7efebc7f7090>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc83f160>'

__spec__ = None # (!) real value is "ModuleSpec(name='_dbus_bindings', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc83f160>, origin='/usr/lib/python3/dist-packages/_dbus_bindings.cpython-36m-x86_64-linux-gnu.so')"
