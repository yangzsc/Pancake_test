...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc75ada0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_bz2', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc75ada0>, origin='/usr/lib/python3.6/lib-dynload/_bz2.cpython-36m-x86_64-linux-gnu.so')"
