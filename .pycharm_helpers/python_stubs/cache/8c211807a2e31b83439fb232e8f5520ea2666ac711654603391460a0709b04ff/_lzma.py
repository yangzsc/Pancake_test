...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc7699b0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lzma', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebc7699b0>, origin='/usr/lib/python3.6/lib-dynload/_lzma.cpython-36m-x86_64-linux-gnu.so')"
