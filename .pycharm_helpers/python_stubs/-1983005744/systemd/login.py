...
__spec__ = None # (!) real value is "ModuleSpec(name='systemd.login', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebb7baa58>, origin='/usr/lib/python3/dist-packages/systemd/login.cpython-36m-x86_64-linux-gnu.so')"
