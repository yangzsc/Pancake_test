...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebcad1da0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_json', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efebcad1da0>, origin='/usr/lib/python3.6/lib-dynload/_json.cpython-36m-x86_64-linux-gnu.so')"
