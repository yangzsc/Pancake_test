...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f33c0095a90>'

__spec__ = None # (!) real value is "ModuleSpec(name='apt_inst', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f33c0095a90>, origin='/usr/lib/python3/dist-packages/apt_inst.cpython-36m-x86_64-linux-gnu.so')"
